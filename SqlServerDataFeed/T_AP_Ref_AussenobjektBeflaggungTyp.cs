...
namespace SqlServerDataFeed
{
    ...
    public partial class T_AP_Ref_AussenobjektBeflaggungTyp
    {
        public T_AP_Ref_AussenobjektBeflaggungTyp()
        {
        ...
        public string ABFT_Kurz_IT { get; set; }
        public string ABFT_Kurz_EN { get; set; }
        public string ABFT_Lang_DE { get; set; }
        public string ABFT_Lang_FR { get; set; }
        public string ABFT_Lang_IT { get; set; }
        ...
        public bool ABFT_IsDefault { get; set; }
        public Nullable<System.DateTime> ABFT_DatumMut { get; set; }
        public string ABFT_DatumUser { get; set; }
